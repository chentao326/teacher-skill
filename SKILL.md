...
如果所有仓库都搜索不到匹配的 skill，**不要放弃**——自动转网络搜索补充：

1. **搜索源**：搜索该人物的公开信息——著作/演讲/访谈/文章
2. **提取要点**：从搜索结果中提取该人物的核心思维框架和代表观点
3. **生成课程**：基于网络信息直接生成教学课程（注意标注信息来源）
4. **进入教学**：同 Step 4，自动进入 Phase 1 开始教学

> **重要**：网络搜索到的信息必须标注来源链接。每条核心观点都需要附上对应的 URL，以便用户可以回查验证。

如果网络搜索也无法获取足够信息（< 3 条可信来源）：
- "目前我还没有找到关于 [人物] 的足够公开信息来构建系统课程。不过我可以用我知道的通用知识来教你 [相关领域] 的核心思维方式，要不要先试试？"
